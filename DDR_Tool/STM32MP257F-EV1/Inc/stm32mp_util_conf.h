...
#define UTIL_UART_INSTANCE      UTIL_USART1
#define UTIL_UART_TX_PIN        UTIL_PIN8
#define UTIL_UART_TX_GPIO_PORT  UTIL_GPIOB
#define UTIL_UART_TX_AF         GPIO_AF6_USART1
#define UTIL_UART_RX_PIN        UTIL_PIN10
#define UTIL_UART_RX_GPIO_PORT  UTIL_GPIOB
#define UTIL_UART_RX_AF         GPIO_AF6_USART1
