...
<label for="collapse-section0" aria-hidden="true">__V1.3.0 / 28-Feb-2025__</label>
<div>			
...
- Support added for STPMIC1L component
- Fix buck1_voltage_table definition not match PMIC datasheet for STPMIC1
