...
/** @addtogroup STM32MP15XX_EVAL_STPMU
  * @{
  */
  
  
/** @defgroup STM32MP15XX_EVAL_STPMU_Private_Constants Private Constants
  * @{
  */
/* Driver for PMIC ---------------------------------------------------------------*/
#if (USE_STPMIC1x == 1)
...
/** @defgroup STM32MP15XX_EVAL_STPMU_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32MP15XX_EVAL_STPMU_Private_Functions Private Functionss
  * @{
  */
