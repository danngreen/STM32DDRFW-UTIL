/**
  ******************************************************************************
  * @file    stm32mp15xx_eval.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage LEDs, 
  *          push-buttons and COM ports available on STM32MP15xx-EVAL 
...
/** @addtogroup STM32MP15XX_EVAL
  * @{
  */

/** @defgroup STM32MP15XX_EVAL_LOW_LEVEL_Private_TypesDefinitions Private Typedef
  * @{
  */
...
/** @defgroup STM32MP15XX_EVAL_LOW_LEVEL_Private_Defines Private Def
  * @{
  */
...
#define STM32MP15XX_EVAL_BSP_VERSION_SUB1   (0x07U) /*!< [23:16] sub1 version */
...
#define STM32MP15XX_EVAL_BSP_VERSION         ((STM32MP15XX_EVAL_BSP_VERSION_MAIN << 24)\
                                             |(STM32MP15XX_EVAL_BSP_VERSION_SUB1 << 16)\
                                             |(STM32MP15XX_EVAL_BSP_VERSION_SUB2 << 8 )\
                                             |(STM32MP15XX_EVAL_BSP_VERSION_RC))
/**
  * @}
  */


/** @defgroup STM32MP15XX_EVAL_LOW_LEVEL_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32MP15XX_EVAL_LOW_LEVEL_Private_FunctionPrototypes Private Prototypes
  * @{
  */
#ifdef HAL_EXTI_MODULE_ENABLED
...
/** @addtogroup STM32MP15XX_EVAL_LOW_LEVEL_Exported_Functions Exported Functions
  * @{
  */ 

  /**
  * @brief  This method returns the STM32MP15XX EVAL BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
uint32_t BSP_GetVersion(void)
{
  return STM32MP15XX_EVAL_BSP_VERSION;
}
...
/** @addtogroup STM32MP15XX_EVAL_LOW_LEVEL_Exported_Functions_Group2 BUTTON Functions
  * @{
  */
...
/** @addtogroup STM32MP15XX_EVAL_LOW_LEVEL_Exported_Functions_Group3 COM Functions
  * @{
  */
/**
...
/** @addtogroup STM32MP15XX_EVAL_LOW_LEVEL_Private_Functions Private Functions
  * @{
  */ 
  
/** @addtogroup STM32MP15XX_EVAL_LOW_LEVEL_Private_Functions_Group1 BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)  
#ifdef HAL_UART_MODULE_ENABLED  
/** @addtogroup STM32MP15XX_EVAL_LOW_LEVEL_Private_Functions_Group2 COM Functions
  * @{
  */
/**
