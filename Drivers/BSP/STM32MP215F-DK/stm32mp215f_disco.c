...
static void USART_MspInit(UART_HandleTypeDef *huart)
{
  ...
  if (huart->Instance == COM_CA35_UART)
  {
    ...
    {
      if (RESMGR_STATUS_ACCESS_OK == ResMgr_Request(RESMGR_RESOURCE_RIF_RCC, COM_CA35_RCC_RES_TX_PIN))
      {
    ...
    {
      if (RESMGR_STATUS_ACCESS_OK == ResMgr_Request(RESMGR_RESOURCE_RIF_RCC, COM_CA35_RCC_RES_RX_PIN))
      {
