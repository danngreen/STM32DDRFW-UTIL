...
- STM32MP257Axx ,STM32MP257Cxx, **STM32MP215Fxx**
...
<label for="collapse-section0" checked aria-hidden="true">__V1.2.0.rc8 / 31-Oct-2024__</label>
<div>

## Main Changes

This is a **v1.2.0.rc8 Release** for STM32MP25xx,STM32MP23xx, STM32MP21xx CMSIS

## Contents
- **Support added for STM32MP21xx**

## Known Limitations

IAR is not yet supported.
...
<label for="collapse-section2" checked aria-hidden="true">__V1.1.0.rc4 / 23-Aug-2024__</label>
<div>
